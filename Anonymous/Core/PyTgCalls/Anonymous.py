...
from Anonymous.Database import get_assistant, remove_active_chat, remove_active_video_chat
...
from Anonymous.Utilities.youtube import get_yt_info_id, get_m3u8
            ...
            if str(finxx) == "raw":
                ...
                if int(quality) == 1080:
                    ...
                    try:
                        ...
                        return await app.send_message(chat_id, "sᴏᴍᴇ ᴇʀʀᴏʀ ᴏᴄᴄᴜʀᴇᴅ ᴡʜɪʟᴇ sᴡɪᴛᴄʜɪɴɢ ᴠɪᴅᴇᴏ sᴛʀᴇᴀᴍ ʙᴀʙʏ. ᴘʟᴀʏᴏᴜᴛ ɪs ᴏɴ ʜᴏʟᴅ ɴᴏᴡ. ᴘʟᴇᴀsᴇ sᴋɪᴘ ᴛʜᴇ sᴛʀᴇᴀᴍ ᴛᴏ ʀᴇsᴜᴍᴇ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ʙᴀʙʏ.")
                    ...
                    finaltext = await app.send_photo(
                        ...
                        reply_markup=InlineKeyboardMarkup(buttons),
                        caption=(
                            f"📽**ᴠɪᴅᴇᴏ sᴛʀᴇᴀᴍɪɴɢ​**\n\n😘<b>__Sᴛᴀʀᴛᴇᴅ ᴘʟᴀʏɪɴɢ:__ </b>ɴᴇxᴛ ᴠɪᴅᴇᴏ ꜰʀᴏᴍ ᴛᴇʟᴇɢʀᴀᴍ​ \n🤗**__Rᴇǫᴜᴇsᴛᴇᴅ ʙʏ:__** {mention} ʙᴀʙʏ"
                        ),
                    )         
                else:  
                    (
                    ...
                    if nrs == 0:
                        return await app.send_message(chat_id, "ꜰᴀɪʟᴇᴅ ᴛᴏ ꜰᴇᴛᴄʜ ᴠɪᴅᴇᴏ ꜰᴏʀᴍᴀᴛs ꜰᴏʀ ɴᴇxᴛ sᴛʀᴇᴀᴍ. ᴘʟᴇᴀsᴇ sᴋɪᴘ ᴛʜᴇ sᴛʀᴇᴀᴍ ᴛᴏ ʀᴇsᴜᴍᴇ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ʙᴀʙʏ.")
                    try:
                        await pytgclients.change_stream(
