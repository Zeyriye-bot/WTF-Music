...
import os
import re
from Anonymous.Core.Clients.cli import LOG_CLIENT
...
from Anonymous.Database import get_active_chats, get_sudoers, remove_active_chat, get_active_video_chats, remove_active_video_chat, is_on_off
...
async def initiate_bot():
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:  
            await ASS_CLI_1.join_chat("AnonymousSupport")
            await ASS_CLI_1.join_chat("AnonymousRobotSupport")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("AnonymousSupport")
            await ASS_CLI_2.join_chat("AnonymousRobotSupport")
        except:
            pass
    ...
    if STRING3 != "None":    
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("AnonymousSupport")
            await ASS_CLI_3.join_chat("AnonymousRobotSupport")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("AnonymousSupport")
            await ASS_CLI_4.join_chat("AnonymousRobotSupport")
        except:
            pass
    ...
    if STRING5 != "None":    
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("AnonymousSupport")
            await ASS_CLI_5.join_chat("AnonymousRobotSupport")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("AnonymousSupport")
