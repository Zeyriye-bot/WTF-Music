...
from Anonymous.Core.PyTgCalls.Anonymous import (join_stream, pause_stream, skip_video_stream,
...
from Anonymous.Inline import (audio_markup, audio_markup2, download_markup, secondary_markup2,
