import asyncio
from driver.anonymous import user
...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        if invitelink.startswith("https://t.me/+"):
            ...
            return await user.send_message(chat_id, "» ᴀssɪsᴛᴀɴᴛ ɪs ɪɴ ᴛʜᴇ ᴄʜᴀᴛ ʙᴀʙʏ​")
    except UserAlreadyParticipant:
        return await user.send_message(chat_id, "» ᴀssɪsᴛᴀɴᴛ ɪs ᴀʟʀᴇᴀᴅʏ​ ɪɴ ᴛʜᴇ ᴄʜᴀᴛ ʙᴀʙʏ​")
...
async def leave_chat(_, m: Message):
    ...
    try:
        ...
        return await _.send_message(
            chat_id,
            "» ᴀssɪsᴛᴀɴᴛ ʟᴇᴀᴠᴇᴅ ᴛʜᴇ ᴄʜᴀᴛ ʙᴀʙʏ​",
        )
    except UserNotParticipant:
        return await _.send_message(
            chat_id,
            "» ᴀssɪsᴛᴀɴᴛ ᴀʟʀᴇᴀᴅʏ​ ʟᴇᴀᴠᴇᴅ ᴛʜᴇ ᴄʜᴀᴛ ʙᴀʙʏ​",
        )
